...
import {
  DeleteFilled, EyeFilled, FilterFilled, PlusCircleFilled, SelectOutlined,
} from '@ant-design/icons';
import { Button, Checkbox, Divider, Input, Pagination, Popconfirm, Row, Select, Table, Tooltip } from 'antd';
...
const User = () => {
  ...
  useEffect(() => {
    searchUsers();
  }, [nameSearch, page, role, department])
  ...
  const downloadUserList = () => {
    ...
    const workSheetName = 'Danh sách người dùng';
    const fileName = `Danh sách người dùng ${new Date().toISOString().substring(0, 10)}.xlsx`;
    ...
    <div>
      <div className="flex-between-center">
        ...
        <div className='flex flex-row gap-6'>
          <ExportToExcel getData={downloadUserList} />
          <Button
