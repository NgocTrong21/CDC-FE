...
module.exports = {
  ...
  CRUD_ORDERS: permission(PermissionSystem.CRUD_ORDERS),
  CRUD_WAREHOUSES: permission(PermissionSystem.CRUD_WAREHOUSES),
  CRUD_CONSUMABLE_SUPPLY: permission(PermissionSystem.CRUD_CONSUMABLE_SUPPLY),
}